...
| --- | --- | --- |
| Introductory lateral-overlap schematic | `rendered_figures/application/fig_lateral_overlap_schematic.pdf` | deterministic explanatory geometry in `paper.render_lateral_overlap_figure` |
| Clearance-grid illustration | `rendered_figures/application/fig_clearance_grid.pdf` | deterministic grid generated by `paper.render_clearance_grid_figure` |
