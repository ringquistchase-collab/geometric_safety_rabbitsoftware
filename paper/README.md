...
the versioned capped projection archive.
...
The introductory schematic and clearance-grid figure are explanatory
application figures generated by the manuscript repository, not by this
library pipeline. They are not needed to reproduce the empirical claims
checked here.
